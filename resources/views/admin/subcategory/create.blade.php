                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="control-container">
                                    ...
                                    <input value="{{old('category_name')}}" class="form-control" name="category_name"
                            ...
                            <div class="col-md-12 form-group">
                                <div class="control-container">
                                    ...
                                    <input value="{{old('category_description')}}" class="form-control"
                                        name="category_description" placeholder="Sub Category Description">
                                </div>
                            </div>
